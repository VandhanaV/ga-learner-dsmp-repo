...
print("Scores of xgb_model are, accuracy_score-",xgb_score," confusion_matrix-",xgb_cm,",classification_report",xgb_cr)
print("Scores of clf_model are, accuracy_score-",clf_score," confusion_matrix-",clf_cm,",classification_report",clf_cr)
